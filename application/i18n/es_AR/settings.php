...
(
	...
	(
		...
		'enable_clean_url' => 'Habilitar URLs amigables',
		'clean_url_enabled' => 'Esta opción habilita Ushahidi para accederse mediante URLs amigables, sin el index.php en la URL.',
		'clean_url_disabled' => 'Parece que su servidor no esta configurado para manejar URLs amigables. Usted debe cambiar la configuración del servidor antes de habilitar esta característica. Usted puede encontrar mas información <a href="http://forums.ushahidi.com/topic/server-configuration-for-apache-mod-rewrite" target="_blank">aquí</a>',
	),
    'map' => array
	(
		'zoom'		=> 'Nivel de zoom',
