...
class Loginf_Controller extends Website_Controller {
    ...
    public function index() {
        ...
        $this->template->header = new View('headerf');
        $this->template->header->site_name = 'SIDCE - Sistema de Información Desastres Naturales del Cesar';
        $this->template->footer = new View('footerf');
        
        // Get custom CSS file from settings
        $this->template->header->site_style = Kohana::config('settings.site_style');

        $this->template->content = new View('loginf');
        $auth = Auth::instance();
