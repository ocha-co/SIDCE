...
<head>
	...
	<?php
        ...
        if (!empty($google_api) && $google_api){
            // Google api without .js, then we use html    
		...
		//Custom javascript
		echo html::script('media/js/general.js');
	?>
  ...
  if (empty($modal)){ ?>
	...
	<div class="rapidxwpr floatholder">
		...
		<div id="header">
			...
			<!-- searchbox -->
			<div id="searchbox" class="clearingfix">
                ...
                <!-- Cellphone -->
                <div id="cellphone">
                    <div class="left"><?php echo html::image('themes/default/img/phone.png') ?></div>
                    <?php echo Kohana::lang('ui_main.cellphone_text')?>
                </div>
                <!-- / Cellphone -->
			...
			<!-- mainmenu -->
                ...
                <ul>
                    <li class="home"><a href="<?php echo url::base() . "main" ?>" <?php if ($this_page == 'home') echo 'class="active"'; ?>><?php echo Kohana::lang('ui_main.home'); ?></a></li>
                    <li class="submit-incident"> <a href="<?php echo url::base() . "reports/submit" ?>"><?php echo Kohana::lang('ui_main.submit'); ?></a></li>
                    <li><a href="<?php echo url::base() . "reports" ?>" <?php if ($this_page == 'reports') echo 'class="active"'; ?>><?php echo Kohana::lang('ui_main.reports_list'); ?></a></li>
                    <li class="last-child"><a href="<?php echo url::base() . "alerts" ?>" <?php if ($this_page == 'alerts') echo 'class="active"'; ?>><?php echo Kohana::lang('ui_main.alerts'); ?></a></li>
                </ul>
					<!--
					<ul>
