							...
							<div class="report_left">
								...
								<div id="custom_forms">
                                    ...
                                    foreach ($forms as $form_id => $form_values){
                                        echo '<li><a href="#tabs-'.$i.'">'.$form_values['title'].'</a></li>';
                                        $i++;
                                    }
                                    echo '</ul>';
                                    ...
                                    $i = 0;
                                    foreach ($forms as $form_id => $form_values){
                                        echo "<div id='tabs-$i'><div class='custom_desc'>".$form_values['desc']."</div>";
                                        foreach ($disp_custom_fields[$form_id] as $field_id => $field_property)
                                        {
                                            ...
                                            { // Text Field
                                                ...
                                                {
                                                    echo form::input('custom_field['.$field_id.']', $form['custom_field'][$form_id][$field_id],
                                            ...
                                            { // TextArea Field
                                                echo form::textarea('custom_field['.$field_id.']', $form['custom_field'][$form_id][$field_id], ' class="custom_text" rows="3"');
                                            }
                                            echo "</div>";
                                        }
                                        echo '</div>';
