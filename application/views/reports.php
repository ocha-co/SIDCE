					...
					<div class="content-bg">
						...
						<div class="big-block">
                            <div style="height:40px;">
                                <div class="left">
                                    <?php echo '<a id="a_reports_xls" href="#" class="boton download_reports_xls">'.Kohana::lang('ui_main.download_reports_xls').'</a>'; ?>
                                </div>
                                <div class="right">
                                    <fieldset>
                                    <label for="startDate"><?php echo Kohana::lang('ui_main.from') ?></label>
                                    <select name="startDate" id="startDate"><?php echo $startDate; ?></select>
                                    <label for="endDate"><?php echo Kohana::lang('ui_main.from_to') ?></label>
							...
							<div id="report_stats">
								<table>
									<tr>
										...
										<th><?php echo Kohana::lang('ui_main.perc_verified')?></th>
									</tr>
									<tr>
