...
?>
			<div class="bg">
				<h2><?php echo $title; ?> <span>(<?php echo $total_items; ?>)</span><a href="<?php print url::site() ?>admin/reports/edit"><?php echo Kohana::lang('ui_main.create_report');?></a>
                ...
                <a href="<?php print url::site() ?>admin/reports/bulletin"><?php echo Kohana::lang('ui_main.humanitarian_bulletin');?></a>
                </h2>
				<!-- tabs -->
				<div class="tabs">
					<!-- tabset -->
