			...
			<div class="bg">
											...
											<td class="col-4">
												<ul>
													<li class="none-separator">
                                                        <a href="#add" onClick="fillFields('<?php echo(rawurlencode($layer_id)); ?>',
                                                                                           '<?php echo(rawurlencode($layer_name)); ?>',
                                                                                           '<?php echo(rawurlencode($layer_url)); ?>',
                                                                                           '<?php echo(rawurlencode($layer_color)); ?>',
                                                                                           '<?php echo(rawurlencode($layer_file)); ?>',
                                                                                           '<?php echo(rawurlencode($layer_type)); ?>',
                                                                                           '<?php echo(rawurlencode($layer_layer)); ?>'
                                                                                           )">
                                                        <?php echo Kohana::lang('ui_main.edit');?></a>
                                                    </li>
				...
				<div class="tabs">
					...
					<div class="tab">
						...
						<div class="tab_form_item">
							<strong><?php echo Kohana::lang('ui_main.layer_type');?>:</strong><br />
							<?php print form::dropdown('layer_type', array('kml/kmz' => 'kml', 'wms' => 'wms')); ?>
						</div>
						<div class="tab_form_item">
							<strong><?php echo Kohana::lang('ui_main.layer_layer');?>:</strong><br />
							<?php print form::input('layer_layer', '', ' class="text"'); ?>
						</div>
						<div class="tab_form_item">
